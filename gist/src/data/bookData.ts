...
const contentRegistry: Record<string, () => Promise<{ default: BookContent }>> = {
  "zero-to-one": () => import("./books/zero-to-one.json"),
  rework: () => import("./books/rework.json"),
  "start-with-why": () => import("./books/start-with-why.json"),
  "tiny-habits": () => import("./books/tiny-habits.json"),
  "intelligent-investor": () => import("./books/intelligent-investor.json"),
  "diamonds-in-the-dust": () => import("./books/diamonds-in-the-dust.json"),
  "principles-changing-world-order": () => import("./books/principles-changing-world-order.json"),
  "the-big-short": () => import("./books/the-big-short.json"),
  "business-adventures": () => import("./books/business-adventures.json"),
  "strategy-beyond-hockey-stick": () => import("./books/strategy-beyond-hockey-stick.json"),
  "capital-allocators": () => import("./books/capital-allocators.json"),
  "mckinsey-mind": () => import("./books/mckinsey-mind.json"),
  "confessions-advertising-man": () => import("./books/confessions-advertising-man.json"),
  "adweek-copywriting-handbook": () => import("./books/adweek-copywriting-handbook.json"),
  "22-immutable-laws-marketing": () => import("./books/22-immutable-laws-marketing.json"),
  "bhagavad-gita": () => import("./books/bhagavad-gita.json"),
};
...
const chaptersRegistry: Record<string, () => Promise<{ default: { chapters: ChapterSummary[] } }>> = {
  "zero-to-one": () => import("./books/zero-to-one.chapters.json"),
  "start-with-why": () => import("./books/start-with-why.chapters.json"),
  "tiny-habits": () => import("./books/tiny-habits.chapters.json"),
  "mckinsey-mind": () => import("./books/mckinsey-mind.chapters.json"),
  "intelligent-investor": () => import("./books/intelligent-investor.chapters.json"),
  "business-adventures": () => import("./books/business-adventures.chapters.json"),
  "22-immutable-laws-marketing": () => import("./books/22-immutable-laws-marketing.chapters.json"),
  "bhagavad-gita": () => import("./books/bhagavad-gita.chapters.json"),
  rework: () => import("./books/rework.chapters.json"),
  "the-big-short": () => import("./books/the-big-short.chapters.json"),
  "confessions-advertising-man": () => import("./books/confessions-advertising-man.chapters.json"),
  "capital-allocators": () => import("./books/capital-allocators.chapters.json"),
  "diamonds-in-the-dust": () => import("./books/diamonds-in-the-dust.chapters.json"),
  "strategy-beyond-hockey-stick": () => import("./books/strategy-beyond-hockey-stick.chapters.json"),
  "principles-changing-world-order": () => import("./books/principles-changing-world-order.chapters.json"),
  "adweek-copywriting-handbook": () => import("./books/adweek-copywriting-handbook.chapters.json"),
};
